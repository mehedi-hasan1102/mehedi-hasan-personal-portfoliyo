  ...
  return (
    <>
      <motion.section
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        className="text-base-content font-geist mx-auto pt-2 max-w-3xl min-h-screen"
      >
        <div className="border border-primary/30 bg-base-200 relative overflow-hidden rounded-lg p-4 backdrop-blur-sm transition-shadow duration-300">
          {/* Header */}
          <motion.div
          ...
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <motion.div
              ...
              className="relative w-full md:w-64 aspect-square overflow-hidden rounded-lg flex-shrink-0"
            >
              <Image
