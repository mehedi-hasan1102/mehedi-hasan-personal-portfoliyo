          ...
          >
            ...
            >
              ...
              <div className="md:w-1/2 w-full p-6 sm:p-8 flex flex-col relative overflow-hidden">
                <button
                  onClick={closeModal}
                  className="absolute top-3 right-3 sm:top-4 sm:right-4 rounded-lg p-2 sm:p-1  text-xl sm:text-2xl  font-mono    transition-all text-red-500 hover:bg-primary/20 hover:scale-120"
