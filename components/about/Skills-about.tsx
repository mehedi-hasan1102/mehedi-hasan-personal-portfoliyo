  ...
  return (
    ...
    >
      ...
      <div className="relative mb-6 sm:mb-20 group w-full flex justify-center">
        ...
        <div className="hidden md:block absolute top-full left-1/2 -translate-x-1/2 w-[90%] max-w-[500px] h-16 md:h-20 pointer-events-none" aria-hidden="true">
  ...
  {skillItems.map(({ category, skills }, idx) => (
    ...
    >
      <motion.span
        ...
        className="text-[9px] sm:text-[10px] uppercase tracking-widest text-base-content/40 mb-3 sm:mb-4 font-bold"
      >
        {category}
      </motion.span>
